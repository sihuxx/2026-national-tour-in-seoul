    ...
    <div class="news-grid">
      ...
      <div class="news-card">
        ...
        <div class="news-fig">
          ...
          <div class="news-fig__txt"><p>서울맞춤투어의 주요일정을 안내해 드립니다.</p></div>
        </div>
        <div class="news-card__foot"><a href="#" class="more">더보기</a></div>
      </div>
      <div class="news-card">
        ...
        <div class="news-fig">
          ...
          <div class="news-fig__txt"><p>투어기간에 펼쳐지는 10개분야 50가지의 다양한 프로그램을 즐겨보세요</p></div>
        </div>
        <div class="news-card__foot"><a href="#" class="more">더보기</a></div>
      </div>
      <div class="news-card">
        ...
        <div class="news-fig">
          ...
          <div class="news-fig__txt"><p>조선왕조 수도 서울에서 소중한 추억을 만들어 보세요</p></div>
        </div>
        <div class="news-card__foot"><a href="#" class="more">더보기</a></div>
      </div>
    </div>
...
<section class="section">
  <div class="wrap">
    ...
    <div class="guide">
      <!-- 달력 -->
      <div class="calendar">
        <div class="calendar__top"><b>2026. 08</b><span>August</span></div>
        <table>
          <thead><tr><th>일</th><th>월</th><th>화</th><th>수</th><th>목</th><th>금</th><th>토</th></tr></thead>
          <tbody>
            <tr><td class="empty">·</td><td class="empty">·</td><td class="empty">·</td><td class="empty">·</td><td class="empty">·</td><td class="event">1</td><td>2</td></tr>
            <tr><td>3</td><td>4</td><td>5</td><td class="event">6</td><td>7</td><td>8</td><td>9</td></tr>
            <tr><td>10</td><td>11</td><td>12</td><td>13</td><td>14</td><td>15</td><td class="event">16</td></tr>
            <tr><td>17</td><td>18</td><td>19</td><td class="event">20</td><td>21</td><td>22</td><td>23</td></tr>
            <tr><td>24</td><td>25</td><td>26</td><td class="event">27</td><td class="event">28</td><td class="event">29</td><td class="event">30</td></tr>
            <tr><td class="event">31</td><td class="empty">·</td><td class="empty">·</td><td class="empty">·</td><td class="empty">·</td><td class="empty">·</td><td class="empty">·</td></tr>
          </tbody>
        </table>
        <div class="cal-legend"><i></i> 축제&amp;행사 · 전시&amp;공연이 있는 날</div>
      </div>

      <!-- 탭 -->
      <div class="tabs">
        <input type="radio" name="gt" id="gt-all" checked hidden>
        <input type="radio" name="gt" id="gt-fest" hidden>
        <input type="radio" name="gt" id="gt-show" hidden>
        <div class="tabs__nav">
          <label for="gt-all">전체</label>
          <label for="gt-fest">축제&amp;행사</label>
          <label for="gt-show">전시&amp;공연</label>
        </div>
        <div class="tabs__body">
          <ul class="panel panel-all">
            <li><span><span class="badge">축제&amp;행사</span>2026 핸드아티코리아</span><span class="date">08.01~08.16</span></li>
            <li><span><span class="badge">축제&amp;행사</span>AI 인사이트 공연문화콘텐츠 기획</span><span class="date">05.12~08.06</span></li>
            <li><span><span class="badge">축제&amp;행사</span>오염코드404: 비점오염원을 찾아라!</span><span class="date">04.07~08.30</span></li>
            <li><span><span class="badge">축제&amp;행사</span>[박인홍 작가] 여행드로잉 클래스</span><span class="date">03.31~08.31</span></li>
            <li><span><span class="badge">축제&amp;행사</span>[이승익 작가] 여행드로잉 클래스</span><span class="date">03.28~08.29</span></li>
            <li><span><span class="badge">축제&amp;행사</span>2026 문화소외층·시니어 [기록으로 기억을 잇다!]</span><span class="date">03.01~08.31</span></li>
            <li><span><span class="badge">전시&amp;공연</span>고소미 개인전 [다양체]</span><span class="date">02.24~08.20</span></li>
            <li><span><span class="badge">전시&amp;공연</span>마인드붐 서울 2025 : 잃어버린 행운 보관소</span><span class="date">08.01~08.27</span></li>
            <li><span><span class="badge">전시&amp;공연</span>서울일러스트레이션페어 V.20</span><span class="date">08.01~08.28</span></li>
          </ul>
          <ul class="panel panel-fest">
            <li><span>2026 핸드아티코리아</span><span class="date">08.01~08.16</span></li>
            <li><span>AI 인사이트 공연문화콘텐츠 기획</span><span class="date">05.12~08.06</span></li>
            <li><span>오염코드404: 비점오염원을 찾아라!</span><span class="date">04.07~08.30</span></li>
            <li><span>[박인홍 작가] 여행드로잉 클래스</span><span class="date">03.31~08.31</span></li>
            <li><span>[이승익 작가] 여행드로잉 클래스</span><span class="date">03.28~08.29</span></li>
            <li><span>2026 문화소외층·시니어 [기록으로 기억을 잇다!]</span><span class="date">03.01~08.31</span></li>
          </ul>
          <ul class="panel panel-show">
            <li><span>고소미 개인전 [다양체]</span><span class="date">02.24~08.20</span></li>
            <li><span>마인드붐 서울 2025 : 잃어버린 행운 보관소</span><span class="date">08.01~08.27</span></li>
            <li><span>서울일러스트레이션페어 V.20</span><span class="date">08.01~08.28</span></li>
          </ul>
        </div>
      </div>
    </div>
