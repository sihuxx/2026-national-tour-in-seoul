...
<section class="section pt">
    ...
    <label>행사 시작일 <input type="date" name="start_date" placeholder="행사 시작일을 입력해주세요" required></label>
    <label>행사 종료일 <input type="date" name="end_date" placeholder="행사 종료일을 입력해주세요" required></label>
